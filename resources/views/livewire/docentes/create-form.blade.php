...
<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            Detalles del nuevo docente
        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Ingresa la información requerida para el nuevo docente
        </p>
    </header>
    ...
    <form wire:submit.prevent='guardar_docente' class="mt-6">
        ...
        <div>
            ...
            <select wire:model.defer="docente.grado" id="grado" name="grado" class="block w-full mt-1"  required>
